        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ url('/blog/posts') }}">Posts</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Posts of Blog</h5>
                                ...
                                <table class="table table-borderless datatable text-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" scope="col">Visit</th>
                                            <th class="text-center" scope="col">Publish Status</th>
