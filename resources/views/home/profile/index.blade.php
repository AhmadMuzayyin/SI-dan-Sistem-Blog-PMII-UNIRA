                ...
                <div class="col-xl-4">
                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            ...
                            <img src="{{ $data->user_images != 'profile-img.jpg' ? url('/storage/uploads/images') . '/' . $data->user_images : url('assets/admin/img/profile-img.jpg') }}"
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade profile-overview active show" id="profile-overview"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8">(0) {{ $data->phone }}</div>
                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="role" type="text" class="form-control" id="role"
                                                    value="{{ $data->role == true ? 'Ketua Komisariat' : 'Ketua Rayon' }}">
                                            </div>
                                        </div>
