        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ url('/teams') }}">Teams</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">STRUKTUR PK</h5>
                            <p>PMII UNIRA PERIODE {{ date('Y') }} - {{ date('Y') + 1 }}</p>
                                    ...
                                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch aos-init aos-animate"
                                        ...
                                        <div class="member">
                                            <div class="member-img">
                                                <img src="{{ url('storage/uploads/images') . '/' . $item->images }}"
